...
public abstract interface FaceGlobal
{
  ...
  public static final String T_ME_ID_USR = "{'html':'html','fullName':'#fb-timeline-cover-name','id':'#pagelet_timeline_main_column','personal':'#pagelet_basic > div > .uiList > ._3pw9','profile_pic':'.profilePic'}";
